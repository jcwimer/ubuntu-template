...
#Standard apps
sudo apt-get install -y curl openssh-server vim build-essential linux-headers-server git tmux zip unzip vim fail2ban htop ntp apache2-utils mysql-client-core-5.5 siege
